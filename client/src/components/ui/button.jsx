...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold ring-offset-white transition",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-main text-main bg-white hover:bg-slate-100 dark:border-stone-800 dark:bg-stone-900 dark:text-stone-50",
        secondary:
